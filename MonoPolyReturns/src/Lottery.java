...
public class Lottery extends Land{
	...
	public void doAction(Player player, GameMapping gameMapping) {
		while (true)
		{
			...
			int s =JOptionPane.showConfirmDialog(null, "Do you want to spend 200 to buy lottery tickets?", "Lottery Shop Option", JOptionPane.YES_NO_OPTION);// input.nextLine();
			if (s==JOptionPane.NO_OPTION)
			{
				break;
			}
			else if (s==JOptionPane.YES_OPTION && player.cashOfPlayer >= 200)
			{
